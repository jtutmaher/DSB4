...
def get_unet():
    ...
    model.compile(optimizer=Adam(lr=1e-4,decay=0.1), loss=dice_coef_loss, metrics=[dice_coef])
...
def train_and_predict():
    ...
    model.fit(images, labels, batch_size=64, epochs=8, verbose=1, shuffle=True,
